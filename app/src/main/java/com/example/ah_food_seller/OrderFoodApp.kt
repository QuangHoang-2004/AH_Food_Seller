...
import com.example.ah_food_seller.view.SettingsScreenMain
        ...
        userDocRef.get()
            .addOnSuccessListener { document ->
                if (document.exists()) {
                    ...
                    val id = document.id
                    val statusRestaurant = document.getBoolean("statusRestaurant") ?: false
                    userProfile.value = Restaurant( id,nameRes, addressRes, resUser.email ?: "", statusRestaurant = statusRestaurant)
                } else {
                }
            }
